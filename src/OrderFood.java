 ...
 * @author User
 */
public class OrderFood extends Reservation {
...
//            emailComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Customer 1", "Customer 2", "Customer 3", "Customer 4" }));
//            emailComboBox.setName(""); // NOI18N
         getComBoEmail();

    }

    int modelCount = viewOrder.model.getRowCount();
    void getComBoEmail(){
           Stack<String> email = new Stack<>();
           for (int i = 0; i <modelCount ; i++) {
                email.add(viewOrder.model.getValueAt(i,2).toString());
               comboBoxModel.addElement(email.peek());
    ...
    javax.swing.JComboBox<String> emailComboBox;
